...
Die gefittete Sinus-Funktion für den Kronkorken bei $z=33.5\,\mathrm{cm}$ lautet wie folgt (siehe Gleichung (\ref{U})):
\begin{align*}
U(t)=(1.158\pm0.009)\mathrm V+(3.615\pm0.012)\mathrm V\cdot \sin((0.8595 \pm 0.0016)\mathrm{s^{-1}}\cdot t + (7.013 \pm 0.008))
\end{align*}
...
Die gefittete Sinus-Funktion für den Kronkorken bei $z=33.5\,\mathrm{cm}$ lautet wie folgt (siehe Gleichung (\ref{U})):
\begin{align*}
U(t)=(-8.757\pm0.009)\mathrm V+(2.44\pm0.06)\mathrm V\cdot \sin((0.87196 \pm 0.00010)\mathrm{s^{-1}}\cdot t + (9.394 \pm 0.011))
\end{align*}
