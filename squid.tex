...
\subsection{Magnetische Eigenschaften \label{Magnet}}
...
Aus dem Fitparameter $b = (1.5 \pm 0.2) *10^{-11} Tm³ $ lässt sich ein theoretischer Wert für ds Dipolmoment bestimmen. Es gilt:

\begin{align*}
& p= \frac{b\cdot 2 \pi}{\mu_0}   &\text{mit } s_p = \frac{s_b\cdot 2 \pi}{\mu_0}\\
\end{align*}

\begin{align*}
\rightarrow p&=7.2 \pm 1.1 \cdot 10^{-5} Am²
\end{align*}
\newpage
